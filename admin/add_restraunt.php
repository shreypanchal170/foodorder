...
if(isset($_POST['submit'])) {
    if(empty($_POST['c_name']) || empty($_POST['res_name']) || empty($_POST['email']) || empty($_POST['phone']) || empty($_POST['password']) || empty($_POST['url']) || empty($_POST['o_hr']) || empty($_POST['c_hr']) || empty($_POST['o_days']) || empty($_POST['address'])) {
        ...
        if($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {        
            if($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO restaurant(c_id,title,email, password ,phone,url,o_hr,c_hr,o_days,address,image) VALUES('".$_POST['c_name']."','".$res_name."','".$_POST['email']."','".$_POST['password']."','".$_POST['phone']."','".$_POST['url']."','".$_POST['o_hr']."','".$_POST['c_hr']."','".$_POST['o_days']."','".$_POST['address']."','".$fnew."')";
                mysqli_query($db, $sql); 
                                ...
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Bussiness Password</label>
                                                    <input type="text" name="password" class="form-control form-control-danger" placeholder="test@1234">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
