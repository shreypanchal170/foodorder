...
// Fetch restaurant name from database based on rs_id
$query = "SELECT title FROM restaurant WHERE rs_id = $res_id";
$result = mysqli_query($db, $query);

// Check if the query was successful and if the restaurant name was found
if ($result && mysqli_num_rows($result) > 0) {
    $row = mysqli_fetch_assoc($result);
    $title = $row['title'];
} else {
    // Default title if not found or query failed
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                ...
                <h3 class="text-primary"> Restaurant Dashboard - <?php echo $title; ?></h3>
