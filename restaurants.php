...
// Rest of your PHP and HTML code for restaurants.php...
?>
        ...
        <div class="page-wrapper">
            ...
            <section class="restaurants-page">
                ...
                while ($rows = mysqli_fetch_array($res)) {
                    // Modify the link to include rs_id as a parameter
                    echo '<div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                            <div class="entry-logo">
                                <a class="img-fluid" href="dishes.php?rs_id='.$rows['rs_id'].'" > 
                                    <img src="admin/Res_img/'.$rows['image'].'" alt="Food logo">
                                </a>
                            </div>
                            <div class="entry-dscr">
                                <h5>
                                    <a href="dishes.php?rs_id='.$rows['rs_id'].'">'.$rows['title'].'</a>
                                </h5> 
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                            <div class="right-content bg-white">
                                <div class="right-review">
                                    <a href="dishes.php?rs_id='.$rows['rs_id'].'" class="btn theme-btn-dash">View Menu</a>
                                </div>
                            </div>
                        </div>';
                }
